...
public class Config {
    ...
    public static void defaultConf(ForgeConfigSpec.Builder config) {
        defaultConfig = config.comment("List of words to censor:").defineList("Censored words/phrases: ", Arrays.asList("Fuck", "Shit")/*Collections.emptyList()*/, s -> s instanceof String);
    }
